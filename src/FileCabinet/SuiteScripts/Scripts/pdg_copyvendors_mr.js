...
define(['N/record', 'N/search'],
    ...
    (record, search) => {
        ...
        * */
        ...
        // const record_type = 'vendor'; // either 'customer' or 'vendor'
        // const subsidiary = 9; // new general subsidiary id
            ...
            try {
                ...
                var mySearch = search.create({
                    ...
                    filters:
                        [
                            ['subsidiary', 'anyof', '2'],
                            'AND', ['custentity_pdg_copiedvendor', 'anyof', '@NONE@'], // ---- for vendors
                            // 'AND', ['altname', 'startswith', 'Ackermann'], // ---- for vendors
                            // 'AND', ['internalid', 'anyof', '241'],
                        ],
                    columns:
                        [
                            'internalid'
        ...
        const map = (mapContext) => {
            try {
                ...
                // MDIMKOV 27.01.2022: if the external id is empty, set it to the marketing subsidiary
                if (!externalid) {

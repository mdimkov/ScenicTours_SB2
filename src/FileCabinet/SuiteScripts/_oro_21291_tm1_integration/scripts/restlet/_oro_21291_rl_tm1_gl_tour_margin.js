    ...
    (search, format) => {
        ...
        const get = (requestParams) => {
            ...
            let glDetailsSearch = search.load({
                id: "customsearch_oro_21291_tm1_gl_tourmargin"
            });
            ...
            if(requestParams.tourCode) {
                glDetailsSearch.filters.push(search.createFilter({
                    name: "custrecord_oro_tour_code",
                    join: "line.cseg_oro_tour",
            ...
            glDetailsSearch.run().each(result => {
                ...
                result.columns.forEach(column => {
                    ...
                    let isCurrencyColumn = ["currency", "foreignCurrency"].includes(label);
